<html>
   ...
   <body>
      ...
      <div class="row g1">
         ...
         <div class="col  link_col">
            <div class="links px-0 p-5">
               ...
               <a href="doner1.php" class="link" > Register_Doner</a>
               <a href="donate.html" class="link"> Donate</a>
               <a href="doner.html" class="link"> Request</a>
               <a href="doner.html" class="link"> Log Out</a>
            </div>
         </div>
      </div>
      <!--End Manu-->
      ...
      <div class="row ">
            ...
            <div class="col-5 col-sm-2 c"><input type="text"  class="form-control" id="formGroupExampleInput" name="ID" >  </div>
